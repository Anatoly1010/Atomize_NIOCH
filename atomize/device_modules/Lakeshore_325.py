...
class Lakeshore_325:
    ...
    def __init__(self):
        ...
        self.path_config_file = os.path.join(self.path_current_directory, 'config', 'Lakeshore_325_config.ini')
        ...
        self.heater_dict = {'25 W': 2, '2.5 W': 1, 'Off': 0,};
                ...
                try:
                    ...
                    try:
                        ...
                        if answer == 0:
                            ...
                            general.message('During internal device test errors were found')
                            self.status_flag = 0
                            sys.exit()
