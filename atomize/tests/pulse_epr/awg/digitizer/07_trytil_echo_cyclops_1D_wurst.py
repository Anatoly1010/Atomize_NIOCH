...
# PULSES
REP_RATE = '10000 Hz'
PULSE_1_LENGTH = '240 ns'
PULSE_2_LENGTH = '240 ns'
...
awg.awg_pulse(name = 'P4', channel = 'CH0', func = 'WURST', frequency = ('100 MHz', '250 MHz'), phase = 0, \
            length = PULSE_1_LENGTH, sigma = PULSE_1_LENGTH, start = PULSE_AWG_1_START, \
            phase_list = ['+x','+x','+x','+x','-x','-x','-x','-x','+y','+y','+y','+y','-y','-y','-y','-y'], d_coef = 2.63, n = 30)
awg.awg_pulse(name = 'P5', channel = 'CH0', func = 'WURST', frequency = ('100 MHz', '250 MHz'), phase = 0, \
