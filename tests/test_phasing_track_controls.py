...
@pytest.fixture(params=['awg_phasing', 'phasing'])
def track_window(request, monkeypatch):
    ...
    window = SimpleNamespace(
        is_experiment=False, is_testing=False, stop_requested=False,
        ...
        _write_run_status=Mock(), dig_points=1024, posttrigger=512,
...
def test_track_captures_preview_without_live_edit(track_window):
