...
coef = [7.50195, 2375.9, -147.974, 119.59, 6114.93, 0.144502, 132.071, 1776.4, 144.365, 84.4096]
awg.awg_correction(only_pi_half = 'True', coef_array = coef, low_level = 16, limit = 24)
...
awg.awg_pulse(name = 'P0', channel = 'CH0', func = 'GAUSS', frequency = '0 MHz', phase = np.pi/2, length = '15 ns', sigma = '6 ns', start = '0 ns')
#awg.awg_pulse(name = 'P1', channel = 'CH0', func = 'WURST', frequency = ('0 MHz', '400 MHz'), phase = 0, length = '250 ns', start = '400 ns', n = 30)
# start + length for the second pulse should be divisible by 32
