...
PULSE_1_START = general.const_shift(PULSE_1_AWG_START, 494)
PULSE_2_START = general.const_shift(PULSE_2_AWG_START, 494)
PULSE_PUMP_START = general.const_shift(PULSE_AWG_PUMP_START, 494)
PULSE_3_START = general.const_shift(PULSE_3_AWG_START, 494)
PULSE_SIGNAL_START = general.const_shift(PULSE_SIGNAL_AWG_START, 494)
...
awg.awg_pulse(name = 'P2', channel = 'CH0', func = 'SINE', frequency = FREQ_OBSERVE, phase = 0, \
...
awg.awg_pulse(name = 'P8', channel = 'CH0', func = 'SINE', frequency = FREQ_PUMP, phase = 0, \
