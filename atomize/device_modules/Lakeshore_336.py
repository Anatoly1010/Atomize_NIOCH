...
class Lakeshore_336:
    ...
    def __init__(self):
        ...
        self.path_config_file = os.path.join(self.path_current_directory, 'config', 'Lakeshore_336_config.ini')
        ...
        self.sens_dict = {0: 'None', 1: 'A', 2: 'B', 3: 'C', 4: 'D',}
        ...
        if self.test_flag != 'test':
            if len(sensor) == 1:
                ...
                if raw_answer2 in self.sens_dict:
                    ...
                    general.message(f'Invalid response of the device {self.__class__.__name__}')
