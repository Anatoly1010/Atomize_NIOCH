        ...
        if self.test_flag != 'test':
            ...
            if  len(mode) == 1:
                ...
                if md in self.gate_dic:
                    ...
                    assert(1 == 2), f"Invalid gate mode; mode: {list(self.gate_dic.keys())}"
            elif len(mode) == 0:
                answer = self.test_gate
                return answer
            else:
                assert(1 == 2), f"Invalid argument; mode: {list(self.gate_dic.keys())}"
        ...
        if self.test_flag != 'test':
            ...
            if len(time) == 1:
                ...
                if scaling in self.scale_dict:
                    ...
                    assert(1 == 2), "Incorrect gate time; time: float + [' s', ' ms', ' us', ' ns']"
            elif len(time) == 0:
                answer = self.test_gate_time
                return answer
            else:
                assert(1 == 2), "Invalid argument; time: float + [' s', ' ms', ' us', ' ns']"
